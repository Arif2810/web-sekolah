...
echo "</div>";
   ...
   <ul style='margin-left:50px' class='shortcut-list'>
	   ...
	   <li><a href=media.php?module=album><img style='height:50px' src='img/album.png'/>Kegiatan Sekolah</a></li>
	   <li><a href=media.php?module=galerifoto><img style='height:50px' src='img/foto.png'/>Foto Kegiatan</a></li>
