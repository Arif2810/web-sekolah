    ...
    echo "<div id='main-content'>
          ...
          <div style='width:50%; float:left'>
			  <p class=inline-small-label> 
			   <label for=field4>NIP</label>
			  <input type=text name='a' value='$row[no_kk]' size=60 disabled>
			   </p> 

			   <p class=inline-small-label> 
			   <label for=field4>Nama Guru</label>
    ...
    echo "<div id='main-content'>
		  ...
		  <div style='width:50%; float:right'>
			  ...
			  <input type=text name='i' value='$row[propinsi]' size=60>
			   ...
			   <input class='button' type='submit' style='width:85px; float:right; margin-right:90px' name='submit' value='Tambah'> 
		  </div>
		  <div style='clear:both'></div>
			  ...
			  <tbody>
			  	  <tr>
			  	  	  ...
			  	  	  <td><input class='button' type='submit' name='submit' value='Tambah'></td>-->
			  	  </tr>";
