<?php if (isset($_GET[kk])){ ?> 
        <article class="article-container" itemscope itemtype="http://schema.org/Article">
            <div class="article-content blog-page">
                <header>
                    <h1 itemprop="headline">Data Guru</h1>
...
<?php }elseif(isset($_GET[idp])){ ?>
        <article class="article-container" itemscope itemtype="http://schema.org/Article">
            <div class="article-content blog-page">
                <header>
                    <h1 itemprop="headline">Detail Data Guru <a href='data-penduduk.html' class='btn btn-warning btn-sm pull-right'>Kembali</a></h1>
                    <div class="divider"></div>
                </header>
                <div class="post-entry" itemprop="articleBody"></div>
